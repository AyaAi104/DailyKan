...
_C.TRAIN.DATA.PREPROCESS.USE_POSE = False
_C.TRAIN.DATA.PREPROCESS.USE_OPTICAL_FLOW = False
...
_C.VALID.DATA.PREPROCESS.USE_POSE = False
...
_C.TEST.DATA.PREPROCESS.USE_POSE = False
...
_C.UNSUPERVISED.DATA.PREPROCESS.USE_POSE = False
...
# -----------------------------------------------------------------------------
# Model Settings for DailyKan
# -----------------------------------------------------------------------------
_C.MODEL.DAILYKAN = CN()
_C.MODEL.DAILYKAN.WIDTH = 32
...
# -----------------------------------------------------------------------------
# Model Settings for LiquidPhys
# -----------------------------------------------------------------------------
_C.MODEL.LIQUIDPHYS = CN()
_C.MODEL.LIQUIDPHYS.EMBED_DIM = 64
_C.MODEL.LIQUIDPHYS.HIDDEN_DIM = 64
_C.MODEL.LIQUIDPHYS.MOTION_EMBED_DIM = 16
_C.MODEL.LIQUIDPHYS.FLOW_DIM = 7
_C.MODEL.LIQUIDPHYS.CFC_MODE = "default"
_C.MODEL.LIQUIDPHYS.MIXED_MEMORY = False
_C.MODEL.LIQUIDPHYS.WEIGHT_DECAY = 1e-4
_C.MODEL.LIQUIDPHYS.FREQ_LOSS_WEIGHT = 0.2
