...
if __name__ == "__main__":
    ...
    if config.TOOLBOX_MODE == "train_and_test":
        ...
        elif config.TRAIN.DATA.DATASET == "Daily":
            train_loader = data_loader.DailyLoader.DailyLoader
        else:
        ...
        elif config.VALID.DATA.DATASET == "Daily":
            valid_loader = data_loader.DailyLoader.DailyLoader
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.TEST.DATA.DATASET == "Daily":
            test_loader = data_loader.DailyLoader.DailyLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+ (Normal and BigSmall preprocessing), UBFC-PHYS and iBVP.")
